...
public abstract class Document {
	...
	protected int countSyllables(String word)
	{
        ...
        char[] vowelsList = new char[] {'a', 'A', 'e', 'E', 'i', 'I', 'o', 'O', 'y', 'Y'};
        ...
        for (int i = 0; i < length - 1; i++) {
        	if (i + 1 < length && word.charAt(i) == word.charAt(i + 1)) continue;
        ...
        // case 5 
            ...
            for (char c : vowelsList) {
                if (c == word.charAt(length - 1) && (word.charAt(length - 1) != 'e' && word.charAt(length - 1) != 'E')) {
                    numSyllables++;
                    break;
                }
            }
